...
#    $CARDANO_CLI query utxo --address $(cat $BASE/.priv/wallets/$1/$1.payment.addr) --testnet-magic $TESTNET_MAGIC
    $CARDANO_CLI query utxo --address $(cat $BASE/.priv/wallets/$1/$1.creator.addr) --testnet-magic $TESTNET_MAGIC
    $CARDANO_CLI query utxo --address $(cat $BASE/.priv/wallets/$1/$1.redeemer.addr) --testnet-magic $TESTNET_MAGIC
