...
writeMyFirstValidatorScript = writeValidator "src/Parameterized/Deploy/Parameterized.plutus" $ OnChain.validator $ OnChain.BenParam 
    {
        ...
        OnChain.creator = Ledger.PaymentPubKeyHash "955ef5e7b76d71fd0dbb1bb163fcd85cf93233fda29da7d279cf01b0",
        OnChain.beneficiary = Ledger.PaymentPubKeyHash "0b44f995ac9ae7290a27c5730a91b2208130b4b9fdde1d03ea8ebd3b",
        OnChain.deadline = 1668931858000    -- will be changed when i run do deadline is used correcty
    }